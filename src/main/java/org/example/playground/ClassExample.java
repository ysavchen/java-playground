 ...
 * <p>
 * В Java более канонический способ - инициализировать поля в конструкторе.
 */
public class ClassExample {
     ...
     * Статический вложенный класс не привязан к экземпляру внешнего класса и не имеют ссылку this$0.<br/>
     ...
     * Статические классы удобны для группировки, когда есть большой класс и с ним по смыслу связаны более маленькие классы.
     */
